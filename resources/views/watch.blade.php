...
@section('content-title')
    <title>Chia sẻ video | Halo - Mạng xã hội</title>
@endsection
                                        ...
                                        <div class="col-sm-12">
                                            <div class="row mx-1 my-2">
                                                ...
                                                <div class="col-sm-8 px-0 mx-0">
                                                    <button type="button"
                                                        class="btn w-100 px-0 btn-light badge-pill  text-muted h-100"
                                                        data-toggle="modal" data-target="#dangbai">
                                                        Bạn có muốn chia sẻ những khoảng khắc vui vẻ?
                                                    </button>
                                                </div>
                                                <div class="col-md-2 text-left">

                                                    <button type="button" class="btn   text-muted h-100 "
                                                        data-toggle="modal" data-target="#dangbai">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('submit', '#upload_form', function(e) {
                e.preventDefault();
                // alert($("#imgpost")[0].files[0].type);
                var data = new FormData(this);
                let TotalImages = $('#imgpost')[0].files.length;
                if (TotalImages > 0) {
                    // for (let i = 0; i < TotalImages; i++) {
                    data.append('imgpost0', $("#imgpost")[0].files[0]);
                    // }
                        ...
                        post =
                            ...
                            <video controls preload="none"\
                                    ...
                                    muted="false" loop="false" style="width:100%; height: 400px; background-color: cadetblue;">\
                                        <source src="http://localhost/mangxh/storage/app/assets/img/baidang/' + data.img[0] + '"\
                                            type="' + data.imgtype[0] +
                            '">\
                                    </video>\
        ...
        function previewImages() {
            ...
            function readAndPreview(i, file) {
                if (!/\.(mp4|avi|mkv|wmv|vob|flv)$/i.test(file.name)) {
                    $('#imgpost').val('');
                    return alert(file.name + " không phải video");
                } else {
