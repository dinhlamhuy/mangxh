                    ...
                    success: function(data) {
                        ...
                        post = '<div class="row mt-2"><div class="col-sm-12 mx-auto"> <div class="card p-0 w-100 "> <div class="card-body p-0 m-0"><div class="row p-0"><div class="col-sm-12"><div class="row mx-1 mt-2">\
                                            ...
                                            <a href="" class="text-decoration-none" style=" vertical-align:baseline; color:black; font-weight: 600; font-size: 18px;">{{ $school->school_name }}</a>\
                                                            <p class="text-muted" style="font-size:13px;">\
                                                                {{ date('d-m-Y', strtotime(date('Y-m-d'))) }}</p>\
                                                        </div>\
                        ...
                        post +=
                            '</div> </div><div class="row pt-2 px-3">\
                                            <div class="col-sm-12">\
                                            <img src="{{ asset('storage/app/assets/img/icon/like.png') }}" style="height: 20px; width:20px; border-radius: 50%; margin-left: -7px;" ><img src="{{ asset('storage/app/assets/img/icon/haha.png') }}" style="height: 20px; width:20px; border-radius: 50%; margin-left: -7px; " alt="">\
                                            <span class="text-muted"> &emsp;2,3k</span>\
                                        <span class="text-muted float-right">234 lượt chia sẻ</span> </div>\
                            ...
                            '" data-toggle="dropdown"\
                                                        aria-haspopup="true" aria-expanded="false" data-icon="like" data-post="' +
                            data
                            .postid +
                            ...
                            .postid + '"><img\
                                            ...
                                            <div class="col-sm-4">\
                                                <button class="btn btn-comment btn-light w-100 "><i class="fa fa-commenting-o" aria-hidden="true"></i>Bình luận</button>\
                                            </div>\
                                            <div class="col-sm-4">\
