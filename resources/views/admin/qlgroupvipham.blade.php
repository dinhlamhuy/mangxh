...
<title>Quản lý danh sách nhóm vi phạm</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                ?>
                <table id="qlgroup" class="text-dark">
                    <thead>
                        <tr>
                            <th>STT</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($list as $usr)
                            <tr>
                                ...
                                <td>{{ 'GR' . sprintf('%05d', $usr->group_id) }}</td>
                       

                                <td>{{ date('H:i d/m/Y', strtotime($usr->ngaytocao)) }}</td>
                                <td>
                                    <a href="{{ url('/groups/'.$usr->group_id) }}" class="btn btn-light"><i class="fa fa-eye" aria-hidden="true"></i></a>
