                        ...
                        <div class="col-sm-12">
                            <div class="row mx-1 mt-2 w-100">
                                ...
                                <div class="pl-4 col-md-10">
                                    ...
                                    <a href="{{ url('/groups/' . $post->group_id) }}" class="text-decoration-none"
                                        style=" vertical-align:baseline; color:black; font-weight: 600; font-size: 18px;">{{ $post->group_name }}</a>
                                    <p class="text-muted" style="font-size:13px;">
                                        {{ date('d/m/Y', strtotime($post->thoigiandang)) }} lúc
                                        {{ date('H:i', strtotime($post->thoigiandang)) }}
                                        ·
                                        @if ($post->group_privacy == '1')
                                            {{-- <i class="fa fa-globe" aria-hidden="true"></i> --}}
                                            <i class="fa fa-users" aria-hidden="true"></i>
                                        @elseif($post->group_privacy == '2')
                                ...
                                <div class=" mb-0 text-right col-md-1 pr-2 ">
                                    ...
                                    <div class="dropdown-menu mr-0 dropdown-menu-right" aria-labelledby="thongbao">
                                        ...
                                        <button class="dropdown-item saved_post" data-post="{{ $post->post_id }}">Lưu
                                            bài
                                            đăng</button>
