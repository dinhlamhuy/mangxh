...
;(function($) {
    ...
    $.fn.imagesGrid.defaults = {
        ...
        getViewAllText: function(imagesCount) {
            return 'Xem tất cả ' + imagesCount + ' ảnh';
        },
        onGridRendered: $.noop,
    ...
    ImagesGridModal.prototype.renderCloseButton = function() {
        this.$modal.append($('<div>', {
            class: 'modal-close mt-1 fa fa-times fa-3x text-light',
            click: this.close
        }));
    }
    ...
    ImagesGridModal.prototype.renderInnerContainer = function() {
        ...
        this.$modal.append(
            $('<div>', {
                ...
                $('<div>', {
                    class: 'modal-control right mt-5',
                    click: this.next
                }).append(
                    $('<div>', {
                        class: 'arrow right'
